...
CREATE TABLE students (
    ...
    roll_no INT NULL,
    udise_no VARCHAR(32) NULL,
    father_aadhar_no VARCHAR(20) NULL,
    mother_aadhar_no VARCHAR(20) NULL,
    father_occupation VARCHAR(200) NULL,
    mother_occupation VARCHAR(200) NULL,
    pen_no VARCHAR(64) NULL,
...
-- Same parent email may be used for multiple siblings; uniqueness is enforced on normalized student Aadhaar when present.
...
-- TENANT TABLES (academic, students, staff, attendance, fees, payroll, timetable, communication)
-- NOTE: This file is a snapshot copy. If you need the full tenant schema,
-- copy the remaining table definitions from `src/db/schema.sql` into this file.
